    ...
    return (
        <View style={tw`relative w-full h-full`}>
            <View style={tw`relative flex flex-row border-b border-gray-200 bg-[${COLOR.PRIMARY}] p-3`}>
                ...
                >
                    <Text style={tw`py-2 pl-4 pr-8`}><FontAwesome name="angle-left" style={tw`text-white text-4xl`} /></Text>
                </TouchableOpacity>
            ...
            <ScrollView style={tw`mb-78`}>
                ...
                <ItemCart price={price} setSubTotal={setSubTotal} subTotal={subTotal} />
                <ItemCart price={price} setSubTotal={setSubTotal} subTotal={subTotal} />
                <ItemCart price={price} setSubTotal={setSubTotal} subTotal={subTotal} />
                <ItemCart price={price} setSubTotal={setSubTotal} subTotal={subTotal} />
                <ItemCart price={price} setSubTotal={setSubTotal} subTotal={subTotal} />
